...
export const missions = [
  ...
  { name: "COBE", icon: "COBE-sm.png" },
  { name: "contour", icon: "contour-sm.png" },
  { name: "Curiosity", icon: "Curiosity-sm.png" },
  { name: "Curiosity", icon: "Curiosity-sm.png" },
  { name: "CYGNSS fleet", icon: "CYGNSS-sm.png fleet" },
  { name: "CYGNSS", icon: "CYGNSS-sm.png" },
  { name: "Dawn", icon: "Dawn-sm.png" },
  { name: "DSCOVR", icon: "DSCOVR-sm.png" },
  { name: "EO" - 1, icon: "EO-sm.png" - 1 },
  { name: "Epoxi", icon: "Epoxi-sm.png" },
  { name: "Epoxi", icon: "Epoxi-sm.png" },
  { name: "ER-2 mission", icon: "ER-sm.png-2 mission " },
  { name: "Euclid", icon: "Euclid-sm.png" },
  { name: "Euclid", icon: "Euclid-sm.png" },

  { name: "Europa", icon: "Europa-sm.png" },
  { name: "Exo Mars Orbiter", icon: "Exo-sm.png Mars Orbiter" },
  { name: "Exo Mars Rover", icon: "Exo-sm.png Mars Rover" },
  { name: "FA 18", icon: "FA-sm.png 18" },

  { name: "Fermi Glast", icon: "Fermi-sm.png Glast" },

  { name: "GALEX", icon: "GALEX-sm.png" },
  { name: "Galileo", icon: "Galileo-sm.png" },
  { name: "GEMS", icon: "GEMS-sm.png" },
  { name: "Geotail", icon: "Geotail-sm.png" },
  { name: "Glory", icon: "Glory-sm.png" },
  { name: "GOES R", icon: "GOES-sm.png R" },

  { name: "GPM", icon: "GPM-sm.png" },

  { name: "Grace", icon: "Grace-sm.png" },

  { name: "Grail", icon: "Grail-sm.png" },
  { name: "Gulf Stream ", icon: "Gulf-sm.png Stream" },
  { name: "Herschel", icon: "Herschel-sm.png" },
  { name: "HETE", icon: "HETE-sm.png" },
  { name: "Hinode", icon: "Hinode-sm.png" },
  { name: "Hitomi Astro H", icon: "Hitomi-sm.png Astro H" },
];
